...
if not exist mapnik_c_api.cpp curl -O https://raw.github.com/springmeyer/mapnik-c-api/master/mapnik_c_api.cpp
...
set PATH=%PATH%;c:\mapnik-v2.2.0\bin
...
if not exist mapnik_c_api.obj cl -c -nologo -Zm200 -Zc:wchar_t- -O2 %MAPNIK_CXXFLAGS% -W3 -w34100 -w34189 %MAPNIK_C_DEFINES% -I"c:\mapnik-v2.2.0\include" -I"c:\mapnik-v2.2.0\include\mapnik\agg" -I"." mapnik_c_api.cpp
